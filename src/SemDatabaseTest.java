...
public class SemDatabaseTest extends TestCase {
    ...
    public void testSearchCost() {
        ...
        semD.searchCost(0, 125);
//        System.out.println(semD.searchCost(0, 125)[1].toString());
//        System.out.println(semD.searchCost(0, 125)[2].toString());
//        System.out.println(semD.searchCost(0, 125)[3].toString());
    }
